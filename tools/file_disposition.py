...
RULES = [
    ...
    ("qta_full_sim.py", RWG,
     ...
     "(IL-01..IL-10). Replaced by the generic workflow (Phase 6); "
     "interlock asserts made explicit in Phase 1.3.",
     "168 Mode-letter hits; 15 asserts"),
    ...
    ("rust/*", EXG,
     ...
     "directive s2"),
    ("QTA_stage9_release_verification/*", REG,
     "Release verification bundle regenerated by "
     "build_release_artifacts.py (new set in Phase 7).",
     ""),
    ("stage7_reports/*", REG,
